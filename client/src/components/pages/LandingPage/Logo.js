  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="logo-button" type="button" onClick={()=>setShowQuestions(true)}>ENTER</button>
        <button className="neu-button" type="button" onClick={()=>setShowQuestions(true)}>ENTER</button>
      </div>
    </div>
      ):(
      <div>
